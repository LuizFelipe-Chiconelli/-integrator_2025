...
export default function DateField({ ref, name, label, placeholder = "", required }: Props) {
    ...
    return (
        <div className="flex flex-col">
            ...
            <input
                ...
                className={`border rounded-sm transition-all focus:outline-1 appearance-none px-4 py-1
