curso_estoque-- MySQL Script generated by MySQL Workbench
-- Thu May  8 11:26:25 2025
...
CREATE TABLE IF NOT EXISTS `descubra_muriae`.`termodeusoaceite` (
  ...
  INDEX `fk_termodeusoaceite_usuario_idx` (`usuario_id`),
  INDEX `fk_termodeusoaceite_termodeuso_idx` (`termodeuso_id`),
  CONSTRAINT `fk_termodeusoaceite_termodeuso`
    FOREIGN KEY (`termodeuso_id`)
    REFERENCES `descubra_muriae`.`termodeuso` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_termodeusoaceite_usuario`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `descubra_muriae`.`usuario` (`usuario_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
